    ...
    <>
      ...
      <div className="w-full">
        <Head>
          ...
          <meta name="description" content="Middlware assignment." />
          <meta property="og:title" content="MW Store" key="title" />
        </Head>
        <div
        ...
        >
          <div className="pt-4 pl-2 sm:pt-12 sm:pl-12 flex flex-col">
            <Tag year="2021" category="Vegetables" />
            <Center
              price="165"
              title={inventory[1].name}
              link={`/product/${slugify(inventory[1].name)}`}
            />
            {/* <Footer designer="Middleware Assignment" /> */}
          </div>
      ...
      <div className="pt-10 pb-6 flex flex-col items-center">
        ...
        <p className="text-gray-600 text-sm">Find the fresh products.</p>
      </div>
