...
MW Store Next provides a way to quickly get up and running with a fully configurable ECommerce site using Next.js.
...
<details>
  <summary>Other MW Store pages</summary>
...
```sh
$ git clone https://github.com/jamstack-cms/MW Store.git
```
...
- Have an idea or a request? Submit [an issue](https://github.com/jamstack-cms/MW Store/issues) or [a pull request](https://github.com/jamstack-cms/MW Store/pulls)!

### Other considerations

#### Server-side processing of payments

To see an example of how to process payments server-side with stripe, check out the [Lambda function in the snippets folder](https://github.com/jamstack-cms/MW Store/blob/next/snippets/lambda.js).
